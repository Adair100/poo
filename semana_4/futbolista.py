class Futbolista :
   ...
   #polimorfismo
    ...
    def patear(self):
      print("patear la poorteria del equipo de visita")
    
    def correr(self):
      print("corre para evitar un gol del equipo visitante")

    def talla(self):
      print("talla de playera y short")
    
    def goles(self):
      print("goles que lleva durantela carrera")

    def peso(self):
      print("evita tener sobrepeso y cansarse ")

    def litro(self):
      print("el litraje que puede tomar agua")

    def edad(self):
      print("proceso juvenil o veterano")
